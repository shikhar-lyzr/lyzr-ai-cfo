...
Ran 12 CSV variants against 5 shape parsers. 55/56 applicable (shape, variant) pairs produce output semantically equivalent to the baseline. PARTIAL: 1, FAIL_DETECT: 0, FAIL_PARSE: 0, N/A: 4.
